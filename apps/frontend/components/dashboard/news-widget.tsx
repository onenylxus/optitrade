...
const mockNews: NewsItem[] = [
  {
    ...
    summary:
      "NHTSA launches new probe into Tesla's Full Self-Driving system covering 2 million vehicles.",
...
export function NewsWidget({ initialData }: NewsWidgetProps) {
  ...
  // 3. 計算平均情緒 (Gauge)
  const avgSentiment =
    newsToDisplay.reduce((acc, curr) => acc + curr.sentiment, 0) / newsToDisplay.length;
