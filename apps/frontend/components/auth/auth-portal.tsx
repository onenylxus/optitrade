...
export function AuthPortal() {
  ...
  useEffect(() => {
    if (!isFirebaseConfigReady()) {
      setErrorMessage('Firebase config missing. Set NEXT_PUBLIC_FIREBASE_* environment variables.');
      return;
    }
    ...
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : 'Unable to initialize Firebase.');
    }
  }, []);
